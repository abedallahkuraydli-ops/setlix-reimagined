...
const AdminDashboard = () => {
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto w-full space-y-8 animate-in fade-in duration-500">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-foreground flex items-center gap-2">
          <TrendingUp className="h-4 w-4 text-primary" /> Total money received
        </h2>
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            Sum of all payments received from clients (sample clients excluded). Open a client profile to see their monthly transactions.
          </p>
        </div>
      </section>
