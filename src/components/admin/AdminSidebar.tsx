import { LayoutDashboard, Users, BookOpen, Calendar, MessageSquare, Settings, Shield, ShieldCheck, ClipboardList, Lock, Library } from "lucide-react";
...
const baseItems = [
  ...
  { title: "Guidebooks", url: "/admin/guidebooks", icon: Library, superOnly: true },
